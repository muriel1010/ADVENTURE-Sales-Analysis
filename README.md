...
1️ **Download the Excel file**: [Sales_Dashboard.xlsx](#)  
2️ **Enable Macros & Data Connections** for full functionality  
3️ **Refresh Power Query** to update data  
4️ **Use Slicers & Filters** to interact with the dashboards  
 ...
 **Customer Behavior:** Discovered high-performing products and customers, aiding in customer retention strategies 
